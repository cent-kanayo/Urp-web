...
import Nwa from '../../assets/lecturers/Ljimore.png';
    ...
    <main>
      <section className="h-[600px] flex flex-col lg:flex-row mb-[80px]">
        <div className="flex-1">
          <img
            src={Nwa}
            alt="Dr. Haruna O. JIMOH"
            className="h-[320px] lg:h-[600px] w-[100%] object-cover"
          />
        </div>
        <div className="flex-1 bg-[#2C3949]  h-[232px] lg:h-auto flex justify-center items-center px-[27px] lg:px-0 py-[17px] lg:py-0">
          <div className="lg:w-[525px] mx-auto lg:px-4">
            ...
            <p className="text-white text-[12px] lg:text-[20px] leading-[150%] my-6 lg:my-[59px]">
              Haruna Jimoh is a resilient and forward-looking urban planner with
              pragmatic approaches in addressing spatial challenges with
      ...
      <section className="max-w-[1117px] mx-auto flex justify-between items-center mb-[40px] px-6 lg:px-0">
        ...
        <div className="flex justify-center gap-x-6 lg:px-0">
          <span className="bg-gray-200 p-2 rounded-md hover:animate-pulse">
            <a
              href="https://ng.linkedin.com/in/haruna-jimoh-ph-d-2a75a5b"
              target="_blank"
      ...
      <section className="max-w-[800px] mx-auto">
        ...
        <div className="text-[12px] lg:text-[16px] leading-[150%] flex flex-col gap-6 px-6 lg:px-0">
          <p>
            ...
            MBA in Information Technology and a Master of Science in
            Geographical Information Science from the National Open University
            of Nigeria and Lund University, Sweden, respectively. He earned his
            doctorate degree from the University of Ibadan, Nigeria.
          </p>
          <p>
            Currently, he serves as a Lecturer in the Department of Urban and
            Regional Planning at the Faculty of Environmental Sciences,
            University of Lagos. His research interests encompass urbanization
            and governance, spatial analysis and resource management,
            environmental planning, and climate adaptation. He is a cluster
            member of Urbanization and Population Dynamics and Spatial Data
            Infrastructure at the University of Lagos' Centre for Housing and
            Sustainable Development.
          </p>
          <p>
            Dr. Haruna Jimoh holds various prestigious affiliations, including
            being a current Fellow of the Commonwealth Futures Climate Research
            of the Association of Commonwealth Universities. He is also a Fellow
            of the Nigerian Institute of Town Planners and a registered Town
            Planner. Known for his pragmatism in providing solutions to spatial
            challenges, he has consulted extensively for private, corporate
            organizations, and government at various levels.
          </p>
        </div>
      </section>
      <section className="lg:h-px-4 bg-[#FAFAFA] py-[52px] my-[64px] lg:my-[80px]">
        <div>
          ...
          <div className="max-w-[1112px] mx-auto">
            <div className="flex justify-center items-center flex-wrap gap-x-4 gap-y-6 lg:gap-x-[24px]">
              <div className="relative w-[162px] lg:w-[260px] h-[200px] lg:h-[360px] bg-[#b7b5b6] rounded-[2px] flex justify-center items-end">
                ...
                <div className="absolute  top-10 lg:top-[74px] lg:max-w-[174px] lg:pl-[4px]">
                  ...
                  <h3 className="w-[102px] lg:w-auto text-[#1B1B1B] font-bold text-[10px] lg:text-[16px]">
                    <a
                      href="https://www.researchgate.net/publication/282850579_Distance-based_geographical_analysis_for_understanding_household_vulnerability_to_vehicular_emission_along_congested_arterial_roads_Case_study_of_Ikeja_Lagos_Nigeria"
                      target="_blank"
                    >
                      Distance-based geographical analysis for understanding
                      household vulnerability to vehicular emission...
                    </a>
                  </h3>
                </div>
              ...
              <div className="relative w-[162px] lg:w-[260px] h-[200px] lg:h-[360px] bg-[#b7b5b6] rounded-[2px] flex justify-center items-end">
                ...
                <div className="absolute  top-10 lg:top-[74px] lg:max-w-[174px] lg:pl-[4px]">
                  ...
                  <h3 className="w-[102px] lg:w-auto text-[#1B1B1B] font-bold text-[10px] lg:text-[16px]">
                    <a
                      href="https://www.researchgate.net/profile/kayode-Omole/publication/252322622_An_examination_of_urban_renewal_exercise_of_Badia_East_of_Lagos_State_Nigeria/links/02e7e51f2fd817a69b000000/An-examination-of-urban-renewal-exercise-of-Badia-East-of-Lagos-State-Nigeria.pdf"
                      target="_blank"
                    >
                      An examination of urban renewal exercise of Badia East of
                      Lagos State, Nigeria
                    </a>
                  </h3>
                </div>
              ...
              <div className="relative w-[162px] lg:w-[260px] h-[200px] lg:h-[360px] bg-[#b7b5b6] rounded-[2px] flex justify-center items-end">
                ...
                <div className="absolute  top-10 lg:top-[74px] lg:max-w-[174px] lg:pl-[4px]">
                  ...
                  <h3 className="w-[102px] lg:w-auto text-[#1B1B1B] font-bold text-[10px] lg:text-[16px]">
                    <a
                      href="https://www.ingentaconnect.com/content/hsp/jurr/2022/00000016/00000002/art00004"
                      target="_blank"
                    >
                      Residents’ satisfaction with urban renewal projects in
              ...
              <div className="relative w-[162px] lg:w-[260px] h-[200px] lg:h-[360px] bg-[#b7b5b6] rounded-[2px] flex justify-center items-end">
                ...
                <div className="absolute  top-10 lg:top-[74px] lg:max-w-[174px] lg:pl-[4px]">
                  ...
                  <h3 className="w-[102px] lg:w-auto text-[#1B1B1B] font-bold text-[10px] lg:text-[15px] leading-[150%]">
                    <a
                      href="https://scholar.google.com/scholar?cluster=14296675389609625194&hl=en&oi=scholarr"
                      target="_blank"
                    >
                      APPRAISAL OF URBAN RENEWAL PROGRAMMES OF BADIA EAST In
                      LAGOS STATE, NIGERIA
                    </a>
                  </h3>
                </div>
            ...
            <div className="mt-[24px] px-6 lg:px-0">
              <p className="mb-4">
                <a
                  href="https://orcid.org/0000-0003-4443-3951"
                  target="_blank"
              ...
              <p className="mb-4">
                <a
                  href="https://scholar.google.com/citations?user=iFe-QdsAAAAJ&hl=en&oi=ao"
                  target="_blank"
                  className="text-[#024B4B] hover:text-[#037171] underline"
                >
                  Google Scholar Link
              ...
              <p className="mb-4">
                <a
                  href="https://www.researchgate.net/profile/Haruna-Jimoh"
                  target="_blank"
                  className="text-[#024B4B] hover:text-[#037171] underline"
                >
            ...
            <div className="flex gap-x-6 justify-center">
              <div className="bg-[#1B1B1B] rounded-[2px] px-6 py-2 flex items-center gap-x-2">
                ...
                <span className="text-[#FDFFFD] text-[14px] underline hover:animate-pulse">
                  <a href="mailto:hjimoh@unilag.edu.ng">Send an E-mail</a>
                </span>
              </div>
            </div>
          </div>
