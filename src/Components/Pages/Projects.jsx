...
const Projects = () => {
  ...
  return (
    <main>
      <section className="flex mb-[80px] projects-bg">
      ...
      <section className="mt-[80px]">
        <div className="flex justify-center gap-6 mb-6">
          <Link to="/projects/single-project" className="max-w-[548px]">
            <img src={P1} alt="" className="w-full" />
            <div>
              <h2 className="text-[24px] text-[#011717] font-medium mb-2">
                Urban Renewal Project of Abule Oja/ Development of University
                Land
              </h2>
              <p className="text-[#1B1B1B] text-[16px]">
                By Year 3 - Group 1 (2023)
              </p>
              <p className="text-[#ADABAB] text-[16px]">29-09-2023</p>
            </div>
          </Link>
          <Link to="/projects/single-project" className="max-w-[548px]">
        ...
        <div className="flex justify-center gap-6">
          <Link to="/projects/single-project" className="max-w-[548px]">
            ...
            <div>
              ...
              <p className="text-[#1B1B1B] text-[16px]">By Akinseye Ayomide</p>
              <p className="text-[#ADABAB] text-[16px]">29-09-2023</p>
            </div>
          </Link>
          <Link to="/projects/single-project" className="max-w-[548px]">
            ...
            <div>
              ...
              <p className="text-[#1B1B1B] text-[16px]">By Muyiwa Ibrahim</p>
              <p className="text-[#ADABAB] text-[16px]">29-09-2023</p>
            </div>
          </Link>
        </div>
